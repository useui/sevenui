...
SevenUI is a registry of 41 components built exclusively on
...
SevenUI ships with 41 components across three waves:
...
The overlay set is complete — dialogs, sheets, a gesture-driven drawer,
menus, and toast — with zero third-party overlay libraries. No Radix,
no vaul, no sonner: every primitive underneath is Base UI.
