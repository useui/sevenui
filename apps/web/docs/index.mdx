---
title: Introduction
description: Base UI powered React primitives, distributed through the shadcn registry. What SevenUI is, why it exists, and what it covers.
---
...
[Components](/components); full pro sections and pages
live in [Blocks](/blocks).
